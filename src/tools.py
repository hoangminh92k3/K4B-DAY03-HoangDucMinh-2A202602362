    ...
    # --------------------------------------------------------------------------
    {
        ...
        "parameters": {
            ...
            "properties": {
                "student_id": {
                    "type": "string",
                    "description": "Mã sinh viên cần đặt lịch: 'SV2026001'"
                },
                "datetime_str": {
                    "type": "string",
                    "description": "Thời gian hẹn: 14:00 15/09/2026"
                },
                "advisor_name": {
                    "type": "string",
                    "description": "Tên cố vấn học tập: Nguyen Van A"
                }
            },
...
def dispatch_tool_call(tool_name: str, arguments: Dict[str, Any]) -> str:
    ...
    # TODO 2.1: Điều tuyến tường minh theo từng tool_name
    try:
